function Controller() {
    ...
    clickedDone ? $.__views.doneButton.addEventListener("click", clickedDone) : __defers["$.__views.doneButton!click!clickedDone"] = true;
    $.__views.detail.rightNavButton = $.__views.doneButton;
